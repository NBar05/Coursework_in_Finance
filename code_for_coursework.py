...
# для отображения распредления и нормировки
...
# и сцепляем с переменными роста
...
# Рисунок 3 -- будем тестить обе переменные
plt.style.use('seaborn-colorblind')
...
print('Whole time: ' + str(datetime.now() - all_time))
...
# Посчитаем, сколько наблюдений предсказаны с точностью в 1%, 5% и 10%, а также посмотрим квантили
